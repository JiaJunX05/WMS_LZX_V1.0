                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="dashboard-subtitle mb-0">Modify existing brand information</p>
                            </div>
                        </div>
                    </div>
                    {{-- 操作按钮区域 --}}
                    <div class="col-lg-4 text-lg-end">
                        <a href="{{ route('admin.attribute_variant.brand.index') }}" class="btn btn-primary">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- 表单内容 -->
                    <form action="{{ route('admin.attribute_variant.brand.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="mb-4">
                            <label for="input_image" class="form-label fw-bold">Brand Image <span class="text-muted">(Optional)</span></label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-upload text-primary"></i></span>
                                <input type="file" class="form-control border-start-0" id="input_image" name="brand_image" accept="image/*">
                            </div>
                            <div class="form-text">
                        ...
                        <!-- Brand Status Selection -->
                        <div class="mb-4">
                            <label class="form-label fw-bold">Brand Status</label>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="card h-100 border status-card {{ $brand->brand_status === 'Available' ? 'selected' : '' }}" data-status="Available">
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            <input type="radio" name="brand_status" value="Available" class="form-check-input me-3" {{ $brand->brand_status === 'Available' ? 'checked' : '' }}>
                                            <div>
                                ...
                                <div class="col-md-6">
                                    <div class="card h-100 border status-card {{ $brand->brand_status === 'Unavailable' ? 'selected' : '' }}" data-status="Unavailable">
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            <input type="radio" name="brand_status" value="Unavailable" class="form-check-input me-3" {{ $brand->brand_status === 'Unavailable' ? 'checked' : '' }}>
                                            <div>
                                                <h6 class="card-title mb-1">
