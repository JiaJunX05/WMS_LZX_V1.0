...
<link rel="stylesheet" href="{{ asset('assets/css/color-template.css') }}">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a href="{{ route('admin.attribute_variant.color.create') }}" class="btn btn-primary">
                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Active Colors</div>
                            </div>
                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Inactive Colors</div>
                            </div>
                ...
                <table class="table custom-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 12%"><div class="table-header">COLOR</div></th>
                            <th style="width: 15%"><div class="table-header">COLOR NAME</div></th>
                            <th style="width: 15%"><div class="table-header">COLOR HEX</div></th>
                            <th style="width: 20%"><div class="table-header">COLOR RGB</div></th>
                            <th style="width: 10%"><div class="table-header">COLOR STATUS</div></th>
                            <th class="text-end pe-4" style="width: 20%"><div class="table-header">ACTIONS</div></th>
                        </tr>
                    </thead>
                    <tbody id="table-body">
                        <!-- Loading State -->
...
<script>
    ...
    window.colorManagementRoute = "{{ route('admin.attribute_variant.color.index') }}";
    window.editColorUrl = "{{ route('admin.attribute_variant.color.edit', ['id' => ':id']) }}";
    window.deleteColorUrl = "{{ route('admin.attribute_variant.color.destroy', ['id' => ':id']) }}";
    window.availableColorUrl = "{{ route('admin.attribute_variant.color.available', ['id' => ':id']) }}";
    window.unavailableColorUrl = "{{ route('admin.attribute_variant.color.unavailable', ['id' => ':id']) }}";
