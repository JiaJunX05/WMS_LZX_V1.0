        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- 表单内容 -->
                    <form action="{{ route('admin.attribute_variant.color.update', $color->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <!-- 添加颜色预览区域 -->
                            <div class="mt-3">
                                <div class="color-preview" id="color-preview" style="background-color: {{ $color->color_hex }};"></div>
                            </div>
                        </div>
