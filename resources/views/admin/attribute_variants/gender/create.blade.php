                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="dashboard-subtitle mb-0">Add a new gender to categorize and manage products</p>
                            </div>
                        </div>
                    </div>
                    {{-- 操作按钮区域 --}}
                    <div class="col-lg-4 text-lg-end">
                        <a href="{{ route('admin.attribute_variant.gender.index') }}" class="btn btn-primary">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    <!-- 表单标题 -->
                    <h2 class="text-primary text-center mb-3">Create Gender</h2>
                    <p class="text-muted text-center">Add a new gender to categorize and manage products</p>
                    <hr>

                    <!-- 表单内容 -->
                    <form action="{{ route('admin.attribute_variant.gender.store') }}" method="post">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0" id="gender_name" name="gender_name" placeholder="Enter gender name (e.g., Men, Women, Kids)" required>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="gender_code" class="form-label fw-bold">Gender Code</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-code text-primary"></i></span>
                                <input type="text" class="form-control border-start-0" id="gender_code" name="gender_code" placeholder="Enter code (e.g., M, W, K, U)" maxlength="10" required>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="gender_description" class="form-label fw-bold">Gender Description <span class="text-muted">(Optional)</span></label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-text-paragraph text-primary"></i></span>
                                <textarea class="form-control border-start-0" id="gender_description" name="gender_description" placeholder="Enter detailed description, size guide, or usage notes" rows="3"></textarea>
                            </div>
                            <div class="form-text">
                                <i class="bi bi-info-circle me-2"></i>
                                Optional description for size guides, age groups, or special notes
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-plus-circle-fill me-2"></i>Create Gender
                        </button>
                    </form>
                </div>
            </div>
