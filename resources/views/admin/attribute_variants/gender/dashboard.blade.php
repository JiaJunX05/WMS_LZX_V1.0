            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a href="{{ route('admin.attribute_variant.gender.create') }}" class="btn btn-primary">
                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Active Genders</div>
                            </div>
                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Inactive Genders</div>
                            </div>
                ...
                <table class="table custom-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%"><div class="table-header">GENDER NAME</div></th>
                            <th style="width: 12%"><div class="table-header">GENDER CODE</div></th>
                            <th style="width: 30%"><div class="table-header">DESCRIPTION</div></th>
...
<script>
    ...
    window.genderManagementRoute = "{{ route('admin.attribute_variant.gender.index') }}";
    window.editGenderUrl = "{{ route('admin.attribute_variant.gender.edit', ['id' => ':id']) }}";
    window.deleteGenderUrl = "{{ route('admin.attribute_variant.gender.destroy', ['id' => ':id']) }}";
    window.availableGenderUrl = "{{ route('admin.attribute_variant.gender.available', ['id' => ':id']) }}";
    window.unavailableGenderUrl = "{{ route('admin.attribute_variant.gender.unavailable', ['id' => ':id']) }}";
