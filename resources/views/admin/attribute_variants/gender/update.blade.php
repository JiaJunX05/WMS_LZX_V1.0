        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- 表单内容 -->
                    <form action="{{ route('admin.attribute_variant.gender.update', $gender->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0" id="gender_code" name="gender_code"
                                       value="{{ $gender->gender_code }}" maxlength="10" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control border-start-0" id="gender_description" name="gender_description"
                                          placeholder="Enter detailed description, size guide, or usage notes" rows="3">{{ $gender->gender_description }}</textarea>
                            </div>
                            <div class="form-text">
