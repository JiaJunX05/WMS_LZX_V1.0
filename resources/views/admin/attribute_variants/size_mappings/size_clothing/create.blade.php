...
@section("title", "Create Clothing Size")
@section("content")
...
<div class="container-fluid py-4">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="dashboard-title mb-1">Create Clothing Sizes</h2>
                                <p class="dashboard-subtitle mb-0">Add single or multiple clothing sizes to categorize and manage products</p>
                            </div>
                        </div>
                    </div>
                    {{-- 操作按钮区域 --}}
    ...
    <!-- 主要内容卡片 - 左右布局 -->
    <form action="{{ route('admin.attribute_variant.size_clothing.store') }}" method="post" id="sizesForm">
        @csrf
        <div class="card shadow-sm border-0">
            <div class="row g-0">
                <!-- 左侧配置区域 -->
                        ...
                        <div class="config-content flex-grow-1">
                            ...
                            <div class="quick-actions mt-auto">
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-outline-primary" id="addCommonClothingSizes">
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 btn-lg">
                                        <i class="bi bi-plus-circle-fill me-2"></i>Create Clothing Sizes
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-9">
                    <div class="sizes-section p-4">
                        ...
                        <div id="initial-message" class="text-center py-5">
                            <i class="bi bi-shirt text-muted" style="font-size: 4rem;"></i>
                            <h5 class="text-muted mt-3">Select Gender to Start</h5>
                            <p class="text-muted">Choose a gender from the left panel to begin adding clothing sizes</p>
                        </div>
                                            ...
                                            <td class="px-3 py-3 align-middle">
                                                <div class="input-wrapper-compact">
                                                    <textarea class="form-textarea-compact" name="sizes[0][measurements]"
                                                              placeholder="Chest: 100cm, Waist: 80cm" rows="2"></textarea>
                                                    <div class="input-icon-compact">
...
@section("scripts")
    <script src="{{ asset('assets/js/size-clothing-create.js') }}"></script>
@endsection
