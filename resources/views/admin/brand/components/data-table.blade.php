...
<div class="card shadow-sm border-0">
    <div class="card-header bg-transparent border-0 pb-3 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" id="export-brands-btn" disabled>
...
<div id="empty-state" class="text-center p-5 d-none">
    ...
    <h4 class="text-secondary fw-semibold mb-3">No Brand Data</h4>
    <p class="text-muted small mb-4">No brands have been created in the system yet</p>
    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#createBrandModal">
        <i class="bi bi-plus-circle-fill me-2"></i>Create First Brand
    </button>
</div>
