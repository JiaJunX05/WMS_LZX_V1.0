                    ...
                    <div class="config-section d-flex flex-column h-100 bg-light p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="img-upload-area" id="image-preview">
                                @if($brand->brand_image && file_exists(public_path('assets/images/' . $brand->brand_image)))
                                    ...
                                    <img id="preview-image" class="img-preview" src="{{ asset('assets/images/' . $brand->brand_image) }}" alt="Brand Preview">
                        ...
                        <div class="alert alert-info border-0 mb-4">
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-info-circle-fill me-2"></i><strong>Current Brand</strong>
                            </div>
                            <div class="small">
                                <div class="mb-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <small class="text-muted">
                                    <i class="bi bi-info-circle me-1"></i>Modify brand configuration below.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 bg-white shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>Enter a unique brand name
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        @php $currentStatus = $brand->brand_status ?? 'Available'; @endphp
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>Choose whether the brand can be used for product management
                                    </div>
                                </div>
