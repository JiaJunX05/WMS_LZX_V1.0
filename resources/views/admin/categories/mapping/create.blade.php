...
<link rel="stylesheet" href="{{ asset('assets/css/common/create-page.css') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <small class="text-info">
                                        ...
                                        <span id="mappingCountText">No mappings added yet</span>
                                    </small>
                                </div>
                            </div>
                ...
                <div class="col-md-9">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4" id="statusSelection" style="display: none;">
                            <hr class="my-4">
                            <h5 class="mb-3">
                                <i class="bi bi-toggle-on text-primary me-2"></i>Mapping Status
                            </h5>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="card h-100 border status-card selected" data-status="Available">
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            <input type="radio" name="mapping_status" value="Available" class="form-check-input me-3" checked>
                                            <div>
                                                <div class="fw-semibold text-success">
                                                    <i class="bi bi-check-circle-fill me-2"></i>Available
                                                </div>
                                                <small class="text-muted">Mapping will be active and usable</small>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 border status-card" data-status="Unavailable">
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Mapping will be inactive</small>
                                            </div>
                                        </label>
                                    </div>
                                </div>
