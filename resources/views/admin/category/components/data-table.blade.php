...
<div class="card shadow-sm border-0">
    <div class="card-header bg-transparent border-0 pb-3 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" id="export-categories-btn" disabled>
            ...
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th style="width: 10%">
                            <div class="fw-bold text-muted small text-uppercase">CATEGORY IMAGE</div>
                        </th>
                        <th style="width: 60%">
                            <div class="fw-bold text-muted small text-uppercase">CATEGORY NAME</div>
                        </th>
                        <th style="width: 15%">
                            <div class="fw-bold text-muted small text-uppercase">CATEGORY STATUS</div>
                        </th>
...
<div id="empty-state" class="text-center p-5 d-none">
    ...
    <h4 class="text-secondary fw-semibold mb-3">No Category Data</h4>
    <p class="text-muted small mb-4">No categories have been created in the system yet</p>
    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#createCategoryModal">
        <i class="bi bi-plus-circle-fill me-2"></i>Create First Category
    </button>
</div>
