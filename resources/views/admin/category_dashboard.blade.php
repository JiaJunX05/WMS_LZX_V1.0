...
<div class="container-fluid py-4">
    ...
    {{-- 页面头部导航 --}}
    @include('components.main-display.dashboard-header.category-header', ['type' => 'dashboard'])

    {{-- 消息提示容器 --}}
    <div id="alertContainer" class="mb-4"></div>

    {{-- 统计卡片区域 --}}
    @include('components.main-display.stats-cards.category-stats-cards')

    {{-- 搜索筛选区域 --}}
    @include('components.main-display.search-filter.category-search-filter')

    {{-- 分类列表表格 --}}
    @include('components.main-display.data-table.category-table')

    {{-- 分页导航区域 --}}
    @include('components.main-display.pagination-nav.category-pagination-nav')
</div>
