                ...
                <table class="table custom-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 25%"><div class="table-header">CATEGORY IMAGE</div></th>
                            <th style="width: 25%"><div class="table-header">CATEGORY NAME</div></th>
                            <th style="width: 20%"><div class="table-header">CATEGORY STATUS</div></th>
