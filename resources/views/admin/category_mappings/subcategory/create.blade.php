                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="dashboard-subtitle mb-0">Add a new subcategory to organize and manage products</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- 表单内容 -->
                    <form action="{{ route('admin.category_mapping.subcategory.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
