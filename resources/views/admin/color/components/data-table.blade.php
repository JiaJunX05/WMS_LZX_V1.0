            ...
            <table class="table table-hover table-striped mb-0">
                <thead class="table-light sticky-top">
                    <tr>
                        ...
                        <th><div class="fw-bold text-muted small text-uppercase">COLOR INFORMATION</div></th>
                        <th class="text-end pe-4" style="width: 20%"><div class="fw-bold text-muted small text-uppercase">COLOR STATUS</div></th>
