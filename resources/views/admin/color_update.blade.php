                    ...
                    <div class="config-section d-flex flex-column h-100 bg-light p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="rounded-3 border border-3 border-white shadow-sm" id="color-preview"
                                style="background-color: {{ $color->color_hex }}; width: 100%; height: 80px; transition: all 0.3s ease;">
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info border-0 mb-4">
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-info-circle-fill me-2"></i><strong>Current Color</strong>
                            </div>
                            <div class="small">
                                <div class="mb-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <small class="text-muted">
                                    <i class="bi bi-info-circle me-1"></i>Modify color configuration below.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 bg-white shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>Enter a unique color name
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>Enter the color's hex code (e.g., #FF0000 for red)
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>RGB code is automatically generated from hex code
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        @php $currentStatus = $color->color_status ?? 'Available'; @endphp
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>Choose whether the color can be used for product management
                                    </div>
                                </div>
