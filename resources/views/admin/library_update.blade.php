                        ...
                        <div class="card border-0 bg-white shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="size_value" id="size_value"
                                           value="{{ $sizeLibrary->size_value }}" placeholder="Enter size value" required>
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>
                                        Choose whether the size can be used for product management
                                    </div>
                                </div>
