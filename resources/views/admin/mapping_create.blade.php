                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select border-start-0" id="category_id" name="category_id">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ $category->category_status === 'Unavailable' ? 'disabled' : '' }}
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select border-start-0" id="subcategory_id" name="subcategory_id">
                                    ...
                                    @foreach($subcategories as $subcategory)
                                        <option value="{{ $subcategory->id }}" {{ $subcategory->subcategory_status === 'Unavailable' ? 'disabled' : '' }}
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <small class="text-muted">
                                    <i class="bi bi-info-circle me-1"></i>Manage and organize your mappings below.
                                </small>
                            </div>
