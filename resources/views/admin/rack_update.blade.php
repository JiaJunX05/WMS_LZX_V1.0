                        ...
                        <div class="mb-4">
                            ...
                            <div class="image-upload-area" id="image-preview">
                                @if($rack->rack_image && file_exists(public_path('assets/images/' . $rack->rack_image)))
                                    ...
                                    <img id="preview-image" class="preview-image" src="{{ asset('assets/images/' . $rack->rack_image) }}" alt="Rack Preview">
                        ...
                        <div class="alert alert-info border-0 mb-4">
                            ...
                            <div class="small">
                                <div class="mb-1">
                                    ...
                                    <span>Number: <strong>{{ $rack->rack_number }}</strong></span>
                                </div>
                                <div class="mb-1">
                                    <i class="bi bi-boxes me-2 text-muted"></i>
                                    <span>Capacity: <strong>{{ $rack->capacity ?? 50 }}</strong></span>
                                </div>
                                <div class="mb-1">
                                    <i class="bi bi-shield-check me-2 text-muted"></i>
                                    <span>Status: <strong>{{ $rack->rack_status ?? 'Available' }}</strong></span>
                                </div>
                                <div>
                                    <i class="bi bi-calendar me-2 text-muted"></i>
                                    <span>Created: <strong>{{ $rack->created_at->format('M d, Y') }}</strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto">
                            <div class="row text-center">
                                <div class="col-12">
                                    ...
                                    <small class="text-muted">Rack Record</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <small class="text-muted">
                                    ...
                                    Modify rack configuration below.
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label fw-bold text-dark mb-2">
                                        <i class="bi bi-hash me-2 text-primary"></i>Rack Number
                                    </label>
                                    <input type="text" class="form-control" id="rack_number" name="rack_number"
                                           value="{{ old('rack_number', $rack->rack_number) }}" placeholder="Enter rack number" required>
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label fw-bold text-dark mb-2">
                                        <i class="bi bi-boxes me-2 text-primary"></i>Rack Capacity
                                    </label>
                                    <input type="number" class="form-control" id="capacity" name="capacity"
                                           value="{{ old('capacity', $rack->capacity ?? 50) }}" placeholder="Enter rack capacity" min="1">
                                    <div class="form-text">
                                        <i class="bi bi-info-circle me-1"></i>
                                        Enter the maximum number of items this rack can hold
                                    </div>
                                </div>

                                {{-- Rack Status Field --}}
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark mb-3">Rack Status</label>
                                    <div class="row g-3">
                                        @php
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    ...
                                    <a href="{{ route('admin.rack.index') }}" class="btn btn-outline-secondary">
