                ...
                <div class="config-section d-flex flex-column h-100 bg-light p-4">
                    ...
                    @if(isset($category))
                        ...
                        <div class="stats-container">
                            <div class="stats-row">
                                <div class="stat-item">
                                    <div class="stat-number text-success" id="availableCount">{{ $sizeLibraries->where('size_status', 'Available')->count() }}</div>
                                    <div class="stat-label">Available</div>
                                </div>
                                <div class="stat-item">
                                    <div class="stat-number text-danger" id="unavailableCount">{{ $sizeLibraries->where('size_status', 'Unavailable')->count() }}</div>
                        ...
                        <div class="stats-container">
                            <div class="stats-row">
                                <div class="stat-item">
                                    ...
                                    <div class="stat-label">Size Entry</div>
                                </div>
                            </div>
                        </div>
                    @endif
...
<script src="{{ asset('assets/js/size-library/size-library-view.js') }}"></script>
