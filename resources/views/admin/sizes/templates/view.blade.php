                                        ...
                                        <tr data-template-id="{{ $template->id }}" class="size-row">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <button class="btn btn-outline-danger btn-sm" onclick="deleteTemplate({{ $template->id }}, '{{ $template->sizeLibrary->size_value }}')">
...
<script src="{{ asset('assets/js/size-library/size-template-view.js') }}"></script>
