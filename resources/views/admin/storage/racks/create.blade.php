...
<div class="container-fluid py-4">
    ...
    <!-- 主要内容卡片 - 左右布局 -->
    <form action="{{ route('admin.storage_locations.rack.store') }}" method="post" id="rackForm" enctype="multipart/form-data">
        @csrf
        <div class="card shadow-sm border-0">
            <div class="row g-0">
                <!-- 左侧配置区域 -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <small class="text-info">
                                        ...
                                        <span id="rackCountText">No racks added yet</span>
                                    </small>
                                </div>
                            </div>
                ...
                <div class="col-md-9">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4" id="statusSelection" style="display: none;">
                            <hr class="my-4">
                            <h5 class="mb-3">
                                <i class="bi bi-toggle-on text-primary me-2"></i>Rack Status
                            </h5>
                            <div class="row g-3">
                                <div class="col-md-6">
                                        ...
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Racks will be active and usable</small>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <label class="card-body d-flex align-items-center" style="cursor: pointer;">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Racks will be inactive</small>
                                            </div>
                                        </label>
                                    </div>
                                </div>
...
<script>
    ...
    window.createRackUrl = "{{ route('admin.storage_locations.rack.store') }}";
