                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="dashboard-subtitle mb-0">Efficiently manage and organize storage racks within designated zones</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- 表单内容 -->
                    <form action="{{ route('admin.storage_locations.location.store') }}" method="post">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                ...
                                Only available zones can be selected
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle me-2"></i>
                                Only available racks can be selected
                            </div>
                        </div>
