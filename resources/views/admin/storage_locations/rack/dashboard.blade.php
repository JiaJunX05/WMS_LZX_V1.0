                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Active Racks</div>
                            </div>
                    ...
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="stats-label">Inactive Racks</div>
                            </div>
                ...
                <table class="table custom-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30%"><div class="table-header">CAPACITY</div></th>
                            <th style="width: 20%"><div class="table-header">RACK STATUS</div></th>
