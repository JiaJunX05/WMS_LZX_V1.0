                ...
                <div class="col-lg-8">
                    <div class="d-flex align-items-center">
                        <div class="header-icon-wrapper d-flex align-items-center justify-content-center me-4">
                            <i class="bi bi-tag-fill text-white display-6"></i>
                        </div>
                        <div>
                            <h2 class="h3 fw-bold mb-1">Subcategory Management</h2>
                            <p class="text-muted mb-0" id="dashboard-subtitle">Manage and organize product subcategories</p>
                        </div>
                    </div>
                </div>
