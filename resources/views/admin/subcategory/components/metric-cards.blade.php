            ...
            <div class="stats-card">
                <div class="stats-card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number" id="total-subcategories">{{ $totalSubcategories ?? 0 }}</div>
                            <div class="small text-muted fw-medium text-uppercase">Total Subcategories</div>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="stats-card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number" id="active-subcategories">{{ $activeSubcategories ?? 0 }}</div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="stats-card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number" id="inactive-subcategories">{{ $inactiveSubcategories ?? 0 }}</div>
                            <div class="small text-muted fw-medium text-uppercase">Unavailable Subcategories</div>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="stats-card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number" id="subcategories-with-image">{{ $subcategoriesWithImage ?? 0 }}</div>
