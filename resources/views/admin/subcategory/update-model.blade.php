{{-- ==========================================
    Update Subcategory 弹窗模态框组件
    功能：在dashboard页面中显示更新subcategory的弹窗
    ========================================== --}}
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateSubcategoryModalLabel">
                    <i class="bi bi-pencil-square me-2"></i>Update Subcategory
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <form id="updateSubcategoryModalForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="config-section d-flex flex-column h-100 bg-light p-4">
                                    ...
                                    <div class="alert alert-info border-0 mb-0">
                                        ...
                                        <div class="small" id="currentSubcategoryInfo">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div>
                                            ...
                                            <small class="text-muted">
                                                ...
                                                Modify the subcategory details below.
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0 bg-white shadow-sm">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="update_subcategory_name" name="subcategory_name"
                                            ...
                                            <div class="col-12 mb-4">
                                                <label class="form-label fw-bold text-dark mb-3">
                                                    <i class="bi bi-shield-check me-2 text-primary"></i>Subcategory Status <span class="text-danger">*</span>
                                                </label>
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <div class="card h-100 border status-card" data-status="Available">
                                                            <label class="card-body d-flex align-items-center" style="cursor: pointer;" for="update_status_available">
                                                                <input type="radio" name="subcategory_status" id="update_status_available" value="Available" class="form-check-input me-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card h-100 border status-card" data-status="Unavailable">
                                                            <label class="card-body d-flex align-items-center" style="cursor: pointer;" for="update_status_unavailable">
                                                                <input type="radio" name="subcategory_status" id="update_status_unavailable" value="Unavailable" class="form-check-input me-3">
                                                                <div class="flex-grow-1">
                                                                    <h6 class="card-title mb-1">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="submitUpdateSubcategoryModal">
