                        ...
                        <div class="alert alert-info border-0 mb-4">
                            ...
                            <div class="small">
                                <div class="mb-1">
                                    ...
                                    <span>Name: <strong>{{ $subcategory->subcategory_name }}</strong></span>
                                </div>
                                <div class="mb-1">
                                    <i class="bi bi-shield-check me-2 text-muted"></i>
                                    <span>Status: <strong>{{ $subcategory->subcategory_status ?? 'Available' }}</strong></span>
                                </div>
                                <div>
                                    <i class="bi bi-calendar me-2 text-muted"></i>
                                    <span>Created: <strong>{{ $subcategory->created_at->format('M d, Y') }}</strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto">
                            <div class="row text-center">
                                <div class="col-12">
                                    ...
                                    <small class="text-muted">Subcategory Record</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 bg-white shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    ...
                                    <a href="{{ route('admin.subcategory.index') }}" class="btn btn-outline-secondary">
