            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h3 fw-bold mb-1">Size Template Management</h2>
                            <p class="text-muted mb-0" id="dashboard-subtitle">Manage and organize size templates</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createTemplateModal">
                        <i class="bi bi-plus-circle-fill me-2"></i>Add Template
                    </button>
                </div>
            </div>
        </div>
