            ...
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th><div class="fw-bold text-muted small text-uppercase">ZONE INFORMATION</div></th>
                        <th class="text-end pe-4" style="width: 20%"><div class="fw-bold text-muted small text-uppercase">ZONE STATUS</div></th>
