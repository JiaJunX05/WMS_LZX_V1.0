                ...
                <div class="stats-card">
                    <div class="stats-card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="stats-icon bg-primary"><i class="bi bi-geo-alt"></i></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="search-input-wrapper">
                            ...
                            <input type="text" class="form-control search-input" id="search-input" placeholder="Search by zone name or location...">
                        </div>
                    </div>
                ...
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="width: 10%"><div class="fw-bold text-muted small text-uppercase">ZONE IMAGE</div></th>
                            <th style="width: 60%"><div class="fw-bold text-muted small text-uppercase">ZONE INFORMATION</div>
                            <th style="width: 15%"><div class="fw-bold text-muted small text-uppercase">ZONE STATUS</div>
