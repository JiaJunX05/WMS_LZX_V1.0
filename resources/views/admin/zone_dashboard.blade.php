                ...
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="width: 60%"><div class="fw-bold text-muted small text-uppercase">ZONE INFORMATION</div></th>
                            <th style="width: 15%"><div class="fw-bold text-muted small text-uppercase">ZONE STATUS</div></th>
