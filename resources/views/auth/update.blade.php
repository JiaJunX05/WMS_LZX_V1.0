        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold">Edit User Information</h4>
                        <p class="text-muted mb-0">Modify user basic information and permission settings</p>
                    </div>
                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    <!-- Form Title -->
                    <h2 class="text-warning text-center mb-3">Edit User Information</h2>
                    <p class="text-muted text-center">Modify user basic information and permission settings</p>
                    <hr>

                    <!-- Edit Form -->
                    <form action="{{ $userRole === 'SuperAdmin' ? route('superadmin.users.update', $user->id) : route('admin.users.update', $user->id) }}" method="post">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-3">
                                    <div class="alert alert-info alert-sm d-flex align-items-center" role="alert">
                                        ...
                                        <small>You can modify user roles to Staff, Admin, or Super Admin</small>
                                    </div>
                                </div>
                            </div>
                        @else
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const roleRadioInputs = document.querySelectorAll('input[name="account_role"]');
