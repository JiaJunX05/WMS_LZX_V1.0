{{-- ==========================================
    ...
    - $title: 页面标题
    - $subtitle: 页面副标题
    - $actionButtonText: 操作按钮文本
    - $actionButtonUrl: 操作按钮链接
    - $actionButtonIcon: 操作按钮图标
    ========================================== --}}
...
@php
    ...
    $actionButtonText = $actionButtonText ?? 'Add New';
                ...
                <div class="col-lg-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="dashboard-subtitle mb-0">{{ $subtitle }}</p>
                        </div>
                    </div>
                </div>
