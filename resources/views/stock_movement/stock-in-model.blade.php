    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title fw-bold" id="stockInModalLabel">
            ...
            <div class="modal-body">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="stock-in-barcode-scanner"
                ...
                {{-- 已扫描产品表格 --}}
                <div class="card shadow-sm border-0 d-none" id="stock-in-scanned-products-card">
                    <div class="card-header bg-transparent border-0 pb-3 mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                <h5 class="mb-0 fw-semibold">Scanned Products</h5>
                                <span class="badge bg-success" id="stock-in-scanned-products-count">0 products</span>
                            </div>
                            <div class="d-flex gap-2">
                                <span class="badge bg-primary fs-6 me-2" id="stock-in-scanned-count">0 items scanned</span>
                                <button class="btn btn-outline-danger btn-sm" id="stock-in-clear-all-btn" disabled>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody id="stock-in-scanned-products-table-body">
                                    {{-- 动态生成已扫描产品 --}}
                                </tbody>
                            </table>
                        </div>
                ...
                {{-- 空状态 --}}
                <div class="card shadow-sm border-0" id="stock-in-empty-state-card">
                ...
                {{-- 提交区域 --}}
                <div class="card shadow-sm border-0 mt-4 d-none" id="stock-in-submit-section">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="stock-in-reference-number" class="form-label fw-medium">
                                <i class="bi bi-tag text-primary me-1"></i>
                                Reference Number <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" id="stock-in-reference-number" required
                                   placeholder="e.g., PO-2024-001, INV-001">
                            <div class="form-text">Required reference number for tracking this stock in batch</div>
                        </div>

                        <button class="btn btn-success w-100" onclick="submitStockIn()" id="stock-in-submit-btn">
...
{{-- 库存入库相关 URL --}}
<script>
    // 库存入库相关 URL（仅在 modal 中需要时设置）
    if (!window.stockInRoute) {
