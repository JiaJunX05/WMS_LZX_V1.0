    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('superadmin.staff_management') }}" class="btn btn-primary">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <!-- Edit Form -->
                    <form action="{{ route('superadmin.update_user_submit', $user->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3 role-cards">
                                ...
                                <!-- SuperAdmin 选项 - 只有 SuperAdmin 可以编辑为 -->
                                @if($currentUserRole === 'SuperAdmin')
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="alert alert-info alert-sm d-flex align-items-center" role="alert">
                                    ...
                                    <small>
                                        ...
                                        @elseif($currentUserRole === 'Admin')
                                            You can only modify user roles to Staff
                                        @else
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="{{ route('superadmin.staff_management') }}" class="btn btn-outline-secondary">
